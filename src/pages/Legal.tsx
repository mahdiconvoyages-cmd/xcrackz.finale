        ...
        <div className="space-y-8 text-slate-300">
          <section className="bg-white/5 backdrop-blur-xl border border-white/20 p-8 rounded-2xl">
            ...
            <div className="pl-4 space-y-1">
              <p><strong className="text-white">Raison sociale :</strong> CHECKSFLEET SAS</p>
            ...
            <p className="mt-4">
              <strong className="text-white">Directeur de publication :</strong> Jean Dupont, Président de CHECKSFLEET SAS
            </p>
          </section>
          ...
          <section className="bg-white/5 backdrop-blur-xl border border-white/20 p-8 rounded-2xl">
            ...
            <div className="pl-4 space-y-1">
              ...
              <p><strong className="text-white">Par courrier :</strong> CHECKSFLEET SAS - DPO, 123 Rue du Convoyage, 75001 Paris, France</p>
            </div>
            <p className="mt-4">
