      ...
      <div className="container mx-auto px-6 py-24 max-w-4xl pt-32">
        ...
        <div className="space-y-8 text-slate-300">
          <section className="bg-white/5 backdrop-blur-xl border border-white/20 p-8 rounded-2xl">
            ...
            <p className="mb-2">
              Le site CHECKSFLEET est édité par :
            </p>
            <div className="pl-4 space-y-1">
              <p><strong className="text-white">Raison sociale :</strong> ChecksFleet</p>
              <p><strong className="text-white">Forme juridique :</strong> Entreprise Individuelle (Micro-entreprise)</p>
              <p><strong className="text-white">Siège social :</strong> 76 Résidence Mas de Pérols, 34470 Pérols, France</p>
            ...
            <p className="mt-4">
              <strong className="text-white">Directeur de publication :</strong> Le gérant de ChecksFleet
            </p>
          </section>
          ...
          <section className="bg-white/5 backdrop-blur-xl border border-white/20 p-8 rounded-2xl">
            ...
            <p className="mb-2">
              Le site CHECKSFLEET est hébergé par :
            </p>
            <div className="pl-4 space-y-1">
          ...
          <section className="bg-white/5 backdrop-blur-xl border border-white/20 p-8 rounded-2xl">
            ...
            <div className="pl-4 space-y-1">
              <p><strong className="text-white">Par email :</strong> contact@checksfleet.com</p>
              <p><strong className="text-white">Par courrier :</strong> ChecksFleet - DPO, 76 Résidence Mas de Pérols, 34470 Pérols, France</p>
            </div>
            <p className="mt-4">
          ...
          <section className="bg-white/5 backdrop-blur-xl border border-white/20 p-8 rounded-2xl">
            ...
            <p className="mb-4">
              Le site CHECKSFLEET utilise des cookies pour améliorer l'expérience utilisateur et analyser le trafic. Les cookies sont de petits fichiers textes stockés sur votre appareil.
            </p>
            <p className="mb-4">
          ...
          <section className="bg-white/5 backdrop-blur-xl border border-white/20 p-8 rounded-2xl">
            ...
            <p>
              En cas de litige, et à défaut d'accord amiable, les tribunaux de Montpellier seront seuls compétents.
            </p>
          </section>
          ...
          <section className="bg-white/5 backdrop-blur-xl border border-white/20 p-8 rounded-2xl">
            ...
            <p className="mb-2">
              Pour toute question concernant les mentions légales ou le site CHECKSFLEET, vous pouvez nous contacter :
            </p>
            <div className="pl-4 space-y-1">
              <p><strong className="text-white">Email :</strong> contact@checksfleet.com</p>
              <p><strong className="text-white">Téléphone :</strong> +33 6 83 39 74 61</p>
