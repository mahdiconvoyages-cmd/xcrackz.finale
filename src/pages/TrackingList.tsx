            ...
            <div className="backdrop-blur-xl bg-white/70 border border-slate-200 rounded-2xl p-6 shadow-xl">
              <div className="mb-4 flex items-center justify-between">
                <h3 className="text-lg font-bold text-slate-900">
                  {selectedMission && selectedMission.status === 'in_progress' ? 'Suivi en temps réel' : 'Carte'}
                </h3>
                      ...
                      <p className="text-slate-500 text-sm mt-2">
                        {selectedMission ? (
                          selectedMission.status === 'in_progress'
                            ...
                            : 'Le tracé GPS s\'affichera lorsque la mission sera en cours'
                        ) : 'Choisissez une mission dans la liste pour afficher les détails'}
                      </p>
                      {selectedMission && selectedMission.status !== 'in_progress' && (
              ...
              <div className="flex items-start justify-between mb-6">
                <div>
                  ...
                  <p className="text-slate-600 mt-1">
                    ...
                    {selectedMission.vehicle_plate && <span className="text-slate-500"> â€¢ {selectedMission.vehicle_plate}</span>}
                  </p>
                </div>
                {(() => {
                ...
                <div className="space-y-4">
                  {selectedMission.price && (
                    <div className="p-4 bg-gradient-to-br from-teal-50 to-cyan-50 border border-teal-200 rounded-xl">
                      ...
                      <p className="text-2xl font-black text-teal-600">{selectedMission.price.toFixed(2)}â‚¬</p>
                    </div>
                  )}
