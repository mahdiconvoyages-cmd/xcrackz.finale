...
export default function MobileDownload() {
  ...
  const ENV_ANDROID_VERSION = (import.meta.env.VITE_ANDROID_VERSION as string | undefined) || '3.0.0';

  const ANDROID_APK_URL = ENV_APK_URL
    ? ENV_APK_URL
    : isDev
      ? '/xcrackzv3.apk' // Local: déposer le fichier dans public/xcrackzv3.apk
      : 'https://bfrkthzovwpjrvqktdjn.supabase.co/storage/v1/object/public/mobile-apps/xcrackzv3.apk'; // Fallback production
