...
export default function MobileDownload() {
  ...
  const ENV_ANDROID_VERSION = (import.meta.env.VITE_ANDROID_VERSION as string | undefined) || '4.0.0';

  const ANDROID_APK_URL = ENV_APK_URL
    ? ENV_APK_URL
    : isDev
      ? '/xcrackzv4.apk' // Local: déposer le fichier dans public/xcrackzv4.apk
      : 'https://bfrkthzovwpjrvqktdjn.supabase.co/storage/v1/object/public/mobile-apps/xcrackzv4.apk'; // Fallback production
