      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 space-y-8">
          ...
          <div className="bg-teal-50 border-2 border-teal-200 rounded-xl p-6 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-teal-800 text-sm leading-relaxed">
                En utilisant CHECKSFLEET, vous acceptez l'ensemble des conditions ci-dessous. 
          ...
          <section>
            ...
            <div className="prose prose-slate max-w-none">
              <p className="text-slate-700 leading-relaxed mb-4">
                ...
                de la plateforme <strong>CHECKSFLEET</strong>, une solution SaaS de gestion de convoyage automobile 
                et de suivi GPS en temps réel.
              </p>
              <p className="text-slate-700 leading-relaxed">
                La plateforme est éditée par <strong>CHECKSFLEET</strong>, Entreprise Individuelle (Micro-entreprise),
                SIRET 848 224 349 00017, dont le siège social est situé au 76 Résidence Mas de Pérols, 34470 Pérols, France.
              </p>
            </div>
          </section>
            ...
            <div className="space-y-3">
              <div className="bg-slate-50 rounded-lg p-4">
                ...
                <p className="text-slate-700 text-sm">
                  Toute personne physique ou morale utilisant la plateforme CHECKSFLEET.
                </p>
              </div>
              <div className="bg-slate-50 rounded-lg p-4">
          ...
          <section>
            ...
            <div className="prose prose-slate max-w-none">
              ...
              <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
                ...
                <li>Vous devez informer CHECKSFLEET immédiatement de toute utilisation non autorisée.</li>
                <li>CHECKSFLEET se réserve le droit de suspendre ou supprimer un compte en cas d'activité suspecte.</li>
              </ul>
          ...
          <section>
            ...
            <div className="prose prose-slate max-w-none">
              <p className="text-slate-700 leading-relaxed mb-4">
                Tous les éléments de la plateforme CHECKSFLEET (logiciel, graphismes, textes, logos, icônes, etc.) 
                sont protégés par le droit d'auteur et appartiennent à CHECKSFLEET ou à ses partenaires.
              </p>
              <p className="text-slate-700 leading-relaxed">
          ...
          <section>
            ...
            <div className="prose prose-slate max-w-none">
              <p className="text-slate-700 leading-relaxed mb-4">
                CHECKSFLEET s'engage à protéger vos données personnelles conformément au Règlement Général 
          ...
          <section>
            ...
            <div className="prose prose-slate max-w-none">
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                CHECKSFLEET s'efforce de maintenir la plateforme accessible 24h/24, 7j/7, mais ne garantit pas 
              ...
              <p className="text-slate-700 leading-relaxed">
                CHECKSFLEET ne pourra être tenu responsable des dommages directs ou indirects résultant de :
              </p>
              <ul className="list-disc pl-6 space-y-2 text-slate-700 mb-4">
              ...
              <p className="text-slate-700 leading-relaxed">
                CHECKSFLEET est un simple intermédiaire technique. Les relations contractuelles entre 
          ...
          <section>
            ...
            <div className="prose prose-slate max-w-none">
              ...
              <h3 className="text-lg font-bold text-slate-900 mb-2">9.2 Par CHECKSFLEET</h3>
              <p className="text-slate-700 leading-relaxed">
                CHECKSFLEET se réserve le droit de suspendre ou supprimer un compte en cas de :
              </p>
              <ul className="list-disc pl-6 space-y-2 text-slate-700">
          ...
          <section>
            ...
            <div className="bg-gradient-to-br from-teal-50 to-cyan-50 border-2 border-teal-200 rounded-xl p-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-slate-900 font-semibold">
                  🏢 ChecksFleet — Entreprise Individuelle<br/>
                  SIRET : 848 224 349 00017<br/>
                  76 Résidence Mas de Pérols, 34470 Pérols, France
                </p>
              </div>
            </div>
          </section>
