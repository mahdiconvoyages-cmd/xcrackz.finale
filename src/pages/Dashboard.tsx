  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        {/* Revenu Total */}
        <div className="group relative bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-500 border border-slate-200 hover:border-purple-300 hover:-translate-y-2">
          <div className="absolute top-0 right-0 w-24 h-24 sm:w-32 sm:h-32 bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-500"></div>
          <div className="relative z-10">
            <div className="flex items-start justify-between mb-3 sm:mb-4">
              <div className="p-2.5 sm:p-3 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg sm:rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-300">
                <DollarSign className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-white" />
              </div>
              <span className="text-xs font-semibold text-slate-500 bg-slate-100 px-2 sm:px-3 py-1 rounded-full">Revenus</span>
            </div>
            <h3 className="text-2xl sm:text-3xl font-black text-slate-800 mb-1">{stats.totalRevenue.toLocaleString('fr-FR')}€</h3>
            <p className="text-xs sm:text-sm font-semibold text-slate-600 mb-2">Total généré</p>
            <div className="flex items-center gap-2 text-xs">
        ...
        {/* Taux de succès */}
        <div className="group relative bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-500 border border-slate-200 hover:border-emerald-300 hover:-translate-y-2">
          <div className="absolute top-0 right-0 w-24 h-24 sm:w-32 sm:h-32 bg-gradient-to-br from-emerald-500/10 to-green-500/10 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-500"></div>
          <div className="relative z-10">
            <div className="flex items-start justify-between mb-3 sm:mb-4">
              <div className="p-2.5 sm:p-3 bg-gradient-to-br from-emerald-500 to-green-500 rounded-lg sm:rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-300">
                <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-white" />
              </div>
              <span className="text-xs font-semibold text-slate-500 bg-slate-100 px-2 sm:px-3 py-1 rounded-full">Succès</span>
            </div>
            <h3 className="text-2xl sm:text-3xl font-black text-slate-800 mb-1">{stats.completionRate.toFixed(1)}%</h3>
            <p className="text-xs sm:text-sm font-semibold text-slate-600 mb-2">Taux de complétion</p>
            <div className="flex items-center gap-2 text-xs">
        ...
        {/* Contacts */}
        <div className="group relative bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-500 border border-slate-200 hover:border-indigo-300 hover:-translate-y-2">
          <div className="absolute top-0 right-0 w-24 h-24 sm:w-32 sm:h-32 bg-gradient-to-br from-indigo-500/10 to-blue-500/10 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-500"></div>
          <div className="relative z-10">
            <div className="flex items-start justify-between mb-3 sm:mb-4">
              <div className="p-2.5 sm:p-3 bg-gradient-to-br from-indigo-500 to-blue-500 rounded-lg sm:rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-300">
                <Users className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-white" />
              </div>
              <span className="text-xs font-semibold text-slate-500 bg-slate-100 px-2 sm:px-3 py-1 rounded-full">Réseau</span>
            </div>
            <h3 className="text-2xl sm:text-3xl font-black text-slate-800 mb-1">{stats.totalContacts}</h3>
            <p className="text-xs sm:text-sm font-semibold text-slate-600 mb-2">Contacts</p>
            <div className="flex items-center gap-2 text-xs">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-xl border border-slate-200">
          ...
          <div className="flex items-end justify-between gap-1 sm:gap-3 h-48 sm:h-64">
        ...
        {/* Missions récentes */}
        <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-xl border border-slate-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
        <div className="bg-gradient-to-br from-teal-600 to-cyan-600 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-xl text-white">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-xl sm:text-2xl font-black">{stats.monthlyRevenue.toLocaleString('fr-FR')}€</p>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-br from-purple-600 to-pink-600 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-xl text-white">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-3 bg-white/20 backdrop-blur rounded-xl">
            ...
            <div>
              ...
              <p className="text-xl sm:text-2xl font-black">{stats.totalCredits}</p>
            </div>
          </div>
        ...
        <div className="bg-gradient-to-br from-indigo-600 to-blue-600 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-xl text-white">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-3 bg-white/20 backdrop-blur rounded-xl">
            ...
            <div>
              ...
              <p className="text-xl sm:text-2xl font-black">{stats.totalInvoices}</p>
            </div>
          </div>
          <div className="text-sm font-medium text-white/90">
