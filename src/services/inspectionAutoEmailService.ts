...
const EMAIL_CONFIG = {
  fromEmail: 'noreply@fleetcheck.fr',
  fromName: 'FleetCheck - Gestion de Transport',
  replyTo: 'contact@fleetcheck.fr',
};
...
<body>
  <div class="container">
    ...
    <div class="footer">
      <p><strong>FleetCheck</strong> - Solution professionnelle de gestion de transport</p>
