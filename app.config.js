export default {
  expo: {
    ...
    extra: {
      ...
      EXPO_PUBLIC_MAPBOX_TOKEN: process.env.EXPO_PUBLIC_MAPBOX_TOKEN || "pk.eyJ1IjoieGNyYWNreiIsImEiOiJjbWR3dzV3cDMxdXIxMmxzYTI0c2Z0N2lpIn0.PFh0zoPCQK9UueLrLKWd0w",
      EXPO_PUBLIC_ONESIGNAL_APP_ID: process.env.EXPO_PUBLIC_ONESIGNAL_APP_ID || "b284fe02-642c-40e5-a05f-c50e07edc86d",
      // Base URL of the deployed web app (used to call serverless API endpoints from mobile)
      appUrl: process.env.EXPO_PUBLIC_APP_URL || process.env.VITE_APP_URL || "https://xcrackz.com",
      eas: {
