-- ============================================================
-- FIX: Complete report RPC - add client_name, overall_condition, vehicle_info
-- Bugs fixed:
--   1. Signatory names (client_name) missing from inspection data
--   2. Contact names from mission creation already included
--   3. overall_condition and vehicle_info for equipment badges
-- ============================================================
