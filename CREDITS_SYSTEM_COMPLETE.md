...
**Achat d'abonnement :**
- 📦 Starter → +10 crédits auto → `user_credits.balance` ✅
- 🚀 Pro → +50 crédits auto → `user_credits.balance` ✅
- 💎 Premium → +150 crédits auto → `user_credits.balance` ✅
- 🏢 Enterprise → +500 crédits auto → `user_credits.balance` ✅
