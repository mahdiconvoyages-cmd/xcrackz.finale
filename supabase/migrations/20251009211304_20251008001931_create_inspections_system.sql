...
BEGIN
  IF NOT EXISTS (
    ...
    AND policyname = 'Users can view own inspections'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'inspections' 
    AND policyname = 'Users can create own inspections'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'inspections' 
    AND policyname = 'Users can update own inspections'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'inspections' 
    AND policyname = 'Users can delete own inspections'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'inspection_defects' 
    AND policyname = 'Users can view own inspection defects'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'inspection_defects' 
    AND policyname = 'Users can create own inspection defects'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'inspection_defects' 
    AND policyname = 'Users can delete own inspection defects'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    AND policyname = 'Users can view own inspection photos'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'inspection_photos' 
    AND policyname = 'Users can create own inspection photos'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'inspection_photos' 
    AND policyname = 'Users can delete own inspection photos'
  ) THEN
