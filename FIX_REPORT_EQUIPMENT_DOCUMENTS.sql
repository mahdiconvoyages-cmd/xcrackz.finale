-- ============================================================
-- FIX: Equipment display + scanned documents + RESTITUTION in reports
-- 
-- Changes:
--   1. vehicle_info is already returned (from FIX_ALL_REPORT_BUGS.sql)
--   2. scanned_documents from inspection_documents table
--   3. Keeps contact fields from FIX_PUBLIC_REPORT_CONTACTS.sql
--   4. NOW ADDS: inspection_restitution_departure + inspection_restitution_arrival
--   5. Adds has_restitution + restitution vehicle info to mission_data
-- ============================================================
...
-- After running, the web reports will show:
--   1. Equipment from vehicle_info JSON (coherent display)
--   2. Scanned documents with titles and download links
-- ============================================================
